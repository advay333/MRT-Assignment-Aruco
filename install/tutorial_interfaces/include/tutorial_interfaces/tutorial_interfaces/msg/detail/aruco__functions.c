...
tutorial_interfaces__msg__Aruco__init(tutorial_interfaces__msg__Aruco * msg)
{
  ...
  if (!sensor_msgs__msg__Image__init(&msg->image)) {
    tutorial_interfaces__msg__Aruco__fini(msg);
    return false;
  }
  return true;
}
...
tutorial_interfaces__msg__Aruco__create()
{
  ...
  tutorial_interfaces__msg__Aruco * msg = (tutorial_interfaces__msg__Aruco *)allocator.allocate(sizeof(tutorial_interfaces__msg__Aruco), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutorial_interfaces__msg__Aruco));
  bool success = tutorial_interfaces__msg__Aruco__init(msg);
  if (!success) {
...
tutorial_interfaces__msg__Aruco__Sequence__init(tutorial_interfaces__msg__Aruco__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__msg__Aruco * data = NULL;

  if (size) {
    data = (tutorial_interfaces__msg__Aruco *)allocator.zero_allocate(size, sizeof(tutorial_interfaces__msg__Aruco), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutorial_interfaces__msg__Aruco__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tutorial_interfaces__msg__Aruco__fini(&data[i - 1]);
      }
...
tutorial_interfaces__msg__Aruco__Sequence__fini(tutorial_interfaces__msg__Aruco__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tutorial_interfaces__msg__Aruco__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__msg__Aruco__Sequence * array = (tutorial_interfaces__msg__Aruco__Sequence *)allocator.allocate(sizeof(tutorial_interfaces__msg__Aruco__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutorial_interfaces__msg__Aruco__Sequence__init(array, size);
  if (!success) {
...
tutorial_interfaces__msg__Aruco__Sequence__destroy(tutorial_interfaces__msg__Aruco__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutorial_interfaces__msg__Aruco__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutorial_interfaces__msg__Aruco__Sequence__are_equal(const tutorial_interfaces__msg__Aruco__Sequence * lhs, const tutorial_interfaces__msg__Aruco__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_interfaces__msg__Aruco__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_interfaces__msg__Aruco__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_interfaces__msg__Aruco);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_interfaces__msg__Aruco * data =
      (tutorial_interfaces__msg__Aruco *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__msg__Aruco__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__msg__Aruco__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_interfaces__msg__Aruco__copy(
